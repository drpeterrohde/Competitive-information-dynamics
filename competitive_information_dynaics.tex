...
\subsubsection{Competing vs non-competing traits}
...
\subsubsection{Strategies as information}
...
\subsubsection{Associative traits}

\subsubsection{Adoptive traits}

preprioritising strategies to promote another trait that has higher success.

\subsubsection{Trait substitution}

\subsubsection{Strategic subservience}
...
\subsection{Meta-utility}

\begin{align}
\mathcal{P}_{\mathcal{S}_i} = \sum_{g\in U} \mathcal{P}_g(\mathcal{S}_i).
\end{align}
...
\subsection{Meta-strategic game-theory}
...
Must optimise the utility to ourselves,
\begin{align}
...
\subsection{Humanism -- Religion \& universal human morals}
